...
for(const required of ["Content-Security-Policy","class=\"skip-link\"","id=\"announcer\"","css/v3.css","css/v4.css"])if(!index.includes(required))throw new Error("index.html: exigence manquante "+required);
...
const cssFiles=["css/tokens.css","css/app.css","css/auth.css","css/v3.css","css/v4.css"];
