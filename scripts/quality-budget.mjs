...
for(const required of ["Content-Security-Policy","class=\"skip-link\"","id=\"announcer\"","src=\"/src/main.ts\""])if(!index.includes(required))throw new Error("index.html: exigence manquante "+required);
...
const cssFiles=["css/tokens.css","css/app.css","css/auth.css","css/v3.css","css/v4.css","css/v7.css"];
...
if(cssGzip>72000)throw new Error("Budget CSS dépassé: "+cssGzip+" octets gzip > 72000");
