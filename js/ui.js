...
export function textarea(value="",opts={}){const el=h("textarea",{name:opts.name||"",placeholder:opts.placeholder||"",required:opts.required||false,rows:opts.rows||null,spellcheck:opts.spellcheck??true});el.value=value??"";return el}
