...
const CACHE = `${PREFIX}workspace-v7-vite`;
...
self.addEventListener("fetch",event=>{
  ...
  const allowed=APP_SHELL.includes(url.pathname)||url.pathname.startsWith("/assets/")||url.pathname.startsWith("/js/");if(!allowed)return;
